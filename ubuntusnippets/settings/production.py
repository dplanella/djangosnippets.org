...
from ubuntusnippets.settings.base import *
...
DATABASES = {
   'default': {
          ...
          'NAME': 'snippets',                      # Or path to database file if using sqlite3.
          'USER': 'snippets_user',                      # Not used with sqlite3.
          'PASSWORD': '77916212',                  # Not used with sqlite3.
